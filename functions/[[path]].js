...
<!DOCTYPE html><html lang="ja"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"><meta name="theme-color" content="#3b82f6"><title>Check-in</title></head>
...
app.get('/', async (c) => {
  ...
  const [notes, todos, chats, memos, checkins, mapNotes] = await Promise.all([ 
  ...
  <main><div class="container">
    ...
    <div class="card col-span-2">
      ...
      <div id="news-list-container">
        <div style="text-align:center; padding:30px; color:var(--mut);">📰 ニュースを取得中...</div>
      </div>
    </div>
  ...
  <script>
    ...
    document.getElementById('news-tabs').addEventListener('click', e => {
      if(e.target.classList.contains('tab-btn')){
        ...
        document.querySelectorAll('.news-list').forEach(x=>x.classList.remove('active-tab'));
