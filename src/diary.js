  ...
  app.get('/diary', async c => {
    ...
    return c.html(html`
      ...
      <body style="font-family:sans-serif; background:#f8fafc; margin:0; padding:0;">
        <header style="display:flex; justify-content:space-between; padding:0.8rem 1.5rem; background:#fff; border-bottom:1px solid #e2e8f0;"><div style="font-size:1.2rem; font-weight:900;">Dashboard</div><div style="display:flex; gap:15px;"><a href="/" style="text-decoration:none; font-weight:600; color:#64748b;">Home</a><a href="/diary" style="text-decoration:none; font-weight:600; color:#3b82f6;">Diary</a><a href="/chat" style="text-decoration:none; font-weight:600; color:#64748b;">Chat</a><a href="/call" style="text-decoration:none; font-weight:600; color:#64748b;">Call</a><a href="/speedtest" style="text-decoration:none; font-weight:600; color:#64748b;">Speed</a></div></header>
